      ...
      <div className="mainNavbarBox" style={{ width: "100%", height: "100vh" }}>
        ...
        <div id="menu-class" style={{ height: "100vh" }} className={menu_class}>
          <div className="navinside">
            ...
            <div onClick={updateMenu}>
              <a href="#skillsPageSection">Healthcare</a>
            </div>
            <div onClick={updateMenu}>
              <a href="#projectsPageSection">Health Blogs</a>
            </div>
            <div onClick={updateMenu}>
              <a href="#contactPageSection">PLUS</a>
            </div>
            <div onClick={updateMenu}>
              <a href="#contactPageSection">discounts</a>
            </div>
            <div onClick={updateMenu}>
              <a href="#contactPageSection">Surgeries</a>
            </div>
            <div onClick={updateMenu}>
              <a href="#contactPageSection">Surgeries</a>
            </div>
